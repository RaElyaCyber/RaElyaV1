...
echo "\033[32;1mAuthor : RaElya_Cyber"
echo "\033[37;1mFeat: Mr.RaElya_Cyber"
echo "\033[35;1mversion Tools: 6"
echo "\033[35;1mTeam : XTREM CYBER TEAM"
echo "\033[33;1mKontak Me : 089650484***"
echo "\033[31;1mPlease For Subcribe Youtube RaElya Cyber:"
echo "\033[92mXtrem Cyber Team" 
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@T00Ls-RaElya_Cyber~#" bro
...
then
clear
toilet -f slant --gay "RaElya_Cyber"
php kfc.php
fi
...
then
clear
toilet -f mono12 -F gay "RaElya_Cyber"
php phd.php
fi
...
then
clear
toilet -f slant -F gay "RaElya_Cyber" 
...
then
clear
toilet -f standard -F gay "RaElya_Cyber" 
...
sleep 1
echo "\033[32;1m================================By RaElya_Cyber================================"
sleep 1
echo ""
echo ""
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "RaElya_Cyber" | lolcat
...
then
clear
cowsay -f sheep.cow "RaElya_Cyber" | lolcat
figlet "RaElya_Cyber" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: RaElya_Cyber"
echo "\033[33;1mTeam: Xtrem Cyber Team"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "RaElya_Cyber" 
figlet "RaElya_Cyber" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
toilet -f big -F gay "RaElya_Cyber " | lolcat
sleep 1
...
then
clear
toilet -f big -F gay " RaElya_Cyber "
sleep 1
apt update && apt upgrade
apt install wget
mkdir ngrok
